...
<div class="d-flex" id="wrapper">
        ...
        <div class="bg-light border-right" id="sidebar">
            ...
            <div class="list-group list-group-flush">
                ...
                <a href="employer.php" class="list-group-item list-group-item-action bg-light"><i class="fas fa-user-tie"></i> Manage Employers</a>
                <a href="job_seeker.php" class="list-group-item list-group-item-action bg-light"><i class="fas fa-users"></i> Job Seekers</a>
